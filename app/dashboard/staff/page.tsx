...
function OverviewCard({
  ...
  return (
    <article className="dashboard-glass-panel flex h-full flex-col p-5 ">
     <div className="flex items-center gap-3">
      ...
      <div className="mt-4">
        <p className="text-xs text-slate-600">{primary.label}</p>
        <p className="mt-0.5 text-2xl font-bold tracking-tight text-slate-900">{primary.value}</p>
      </div>

      {secondary ? (
        <div className="mt-3 border-t border-slate-200 pt-3">
          <p className="text-xs text-slate-600">{secondary.label}</p>
...
export default async function StaffDashboardPage({
  ...
  return (
    ...
    <div className="page-shell space-y-3 py-4 sm:py-4">
      <div className="dashboard-glass-panel space-y-3 p-4">
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-slate-700">Welcome back, Staff! Here&apos;s what&apos;s happening today.</p>
          </div>
                      ...
                      return (
                        <tr key={row.id} className="border-b border-slate-200 last:border-0">
                          ...
                          <td className="px-2 py-3">
                            ...
                            {row.serviceTitle ? <p className="text-slate-500">({row.serviceTitle})</p> : null}
                          </td>
        ...
        <section aria-label="Upcoming bookings and reminders" className="dashboard-fade-in grid gap-4 lg:grid-cols-2" style={{ animationDelay: "240ms" }}>
          <div className="dashboard-glass-panel p-5">
            <div className="flex items-center justify-between">
                ...
                return (
                  <div key={row.id} className="flex items-center gap-3 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="truncate text-xs text-slate-700">{row.guestName}</p>
