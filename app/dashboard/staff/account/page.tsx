        ...
        <Card className="overflow-hidden">
          ...
          <CardContent className="space-y-3 p-5 sm:p-6">
            <p className="text-sm leading-6 text-muted-foreground">
              This page is only for staff account access. The destination services, packages,
              pricing, daily slot capacity, and closure dates are managed from the services page.
            </p>
