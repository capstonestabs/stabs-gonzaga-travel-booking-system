      ...
      <Card className="dashboard-glass-panel overflow-hidden">
        ...
        <CardContent className="grid gap-3 p-4 text-sm sm:grid-cols-3">
          {[
            ...
            <div key={label} className="flex items-start gap-3 rounded-[0.95rem] border border-white/30 bg-white/15 p-3">
        ...
        {destination ? (
          <CardContent className="border-t border-white/30 p-4">
        ...
        <div className="grid gap-4">
          <AdminStaffPasswordForm staffId={bundle.user.id} className="dashboard-glass-panel" />
