    ...
    <Card className="w-full max-w-lg border-border/80 bg-card/95">
      ...
      <CardContent>
        ...
        >
          ...
          {isSignUp ? (
            <label className="flex items-start gap-3 rounded-[0.95rem] border border-border/70 bg-muted/35 p-3 text-sm leading-6">
              <input name="privacyAccepted" type="checkbox" required className="mt-1 h-4 w-4" />
              <span>
                I accept the <Link href={"/privacy" as Route} target="_blank" className="font-semibold text-primary underline">Privacy Notice</Link> and understand the <Link href={"/ai-disclosure" as Route} target="_blank" className="font-semibold text-primary underline">AI Disclosure</Link>.
              </span>
            </label>
          ) : null}
