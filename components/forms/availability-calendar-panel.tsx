  ...
  return (
    <div className={cn(
      ...
      <Calendar
        ...
        classNames={compactDesktop ? {
          month: "space-y-4 xl:space-y-2",
          month_grid: "w-full border-separate border-spacing-y-1.5 xl:border-spacing-y-1",
          weekday: "flex h-8 items-center justify-center text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground xl:h-6",
          day: "relative h-10 w-full p-0 text-center text-sm xl:h-8",
          day_button: "h-10 w-full rounded-[0.9rem] border border-transparent bg-transparent p-0 text-sm font-medium text-foreground shadow-none hover:border-border/70 hover:bg-secondary/70 xl:h-8 xl:rounded-[0.7rem]"
        } : undefined}
      />
