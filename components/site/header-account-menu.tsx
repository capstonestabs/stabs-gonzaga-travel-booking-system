        ...
        >
          ...
          <div className="grid gap-1.5 p-2">
            <Link
              ...
              className="flex min-h-11 items-center gap-2.5 rounded-[0.95rem] border border-transparent px-3 text-sm font-medium text-foreground transition hover:border-border/70 hover:bg-muted/65"
            >
