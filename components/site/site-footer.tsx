      ...
      <div className="relative">
        <div className="page-shell grid grid-cols-1 gap-4 py-6 sm:gap-5 sm:py-8 lg:grid-cols-[1.15fr,0.72fr] lg:items-start">
          ...
          <div className="flex flex-wrap gap-2 lg:justify-self-start">
            ...
            <Link href={"/privacy" as Route} className="inline-flex min-h-11 items-center rounded-full border border-white/16 bg-white/6 px-4 py-2 text-sm font-medium text-primary-foreground/88 transition hover:bg-white/10 hover:text-white">
              Privacy
            </Link>
            <Link href={"/ai-disclosure" as Route} className="inline-flex min-h-11 items-center rounded-full border border-white/16 bg-white/6 px-4 py-2 text-sm font-medium text-primary-foreground/88 transition hover:bg-white/10 hover:text-white">
              AI disclosure
            </Link>
          </div>
        </div>
