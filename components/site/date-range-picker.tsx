...
export function DateRangePicker({
  ...
  useEffect(() => {
    ...
    function handleClickOutside(event: MouseEvent) {
      ...
      const clickedInsideDropdown = target.closest('[data-date-range-dropdown]') !== null;
  ...
  return (
    <div ref={containerRef} className="relative inline-block" data-date-range-picker>
      <Button
        ref={triggerRef}
        type="button"
        variant="outline"
      ...
      {open && dropdownPosition
        ? createPortal(
            <div
              ...
              className="fixed z-50 flex max-h-[min(30rem,80vh)] w-[min(34rem,92vw)] overflow-hidden rounded-[1.1rem] border border-border/70 bg-card shadow-[0_22px_50px_rgba(22,74,47,0.16)]"
