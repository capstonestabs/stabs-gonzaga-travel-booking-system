...
const adminSections = [{ title: "Admin workspace", items: workspaceNavByRole.admin }];
  ...
  return (
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 py-4">
        <DashboardNav items={workspaceNavByRole.admin} sections={adminNavSections} variant="sidebar" collapsed={collapsed} />
      </div>
